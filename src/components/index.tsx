    ...
    <div>
      <div className="main _grey">
        <div className="main-with-image">
          <div className="right">
            <h1>AlpinaGen</h1>
            {/*<h3>Простое и эффективное SaaS-решение для вас или вашего бизнеса.</h3>*/}
            <h3>Простое и эффективное SaaS-решение для вашего бизнеса.</h3>
            {/*<p>AlpinaGen – Корпоративная ИИ платформа, объединяющая возможности различных нейронных сетей в удобном интерфейсе. Предназначенная как для частных, так и для корпоративных клиентов, Alpina автоматизирует рутинные задачи и оптимизирует повседневные операции. </p>*/}
            <p>AlpinaGen – корпоративная ИИ платформа, объединяющая возможности различных нейронных сетей в удобном интерфейсе. AlpinaGen автоматизирует рутинные задачи и оптимизирует повседневные операции.</p>
